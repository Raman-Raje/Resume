...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
      	\resumeItem{NC-SDK(Python/C++/DL/TVM/CV)}
        	\resumeSubPointS
        		...
        		\item Implemented support for LSTM/RNN in Imagination NCSDK for Networks present in PyTorch,Tensorflow,Onnx.
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Languages:}{Python, C++, R(basics)}
	...
	\resumeSubItem{Others:}{GitHub, svn, Jira, Jenkins, Service Now etc.,}
  \resumeSubHeadingListEnd 
