...
\resumeSubHeadingListStart
	...
	\resumePoint{Well versed with libraries such as Numpy, Pandas, Matplotlib, OpenCV, SciPy. Experience in dockerization.}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
      	\resumeItem{Anthem - Symphony(Python/DL/ML/NLP)}
        	\resumeSubPointS
        		\item Implement Document Classification to classify documents into different categories. 
        		...
        		\item Implemented NER model to extract required entities and language processing.
        		\item Working on OCR to extract the data from scanned images using aws,Tesseract.
