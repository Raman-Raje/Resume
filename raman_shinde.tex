...
\resumeSubHeadingListStart
	...
	\resumePoint{Experience in implementing research papers and model building using TensorFlow, Keras, Pytorch for model building. Flask API's for model serving.}
