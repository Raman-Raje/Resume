...
\resumeSubHeadingListStart
	...
	\resumePoint{Experience in various ML algorithms(KNN,K-means,Naive Bayes,Logistic Regression,SVM,DT,Random Forest,GBDT etc.)}
	...
	\resumePoint{Well versed with applications such as Docker, Kubernetes. Experience in using GCP/AWS when there's a need for high computing power.}
