      ...
      \resumeItemListStart
      	\resumeItem{NC-SDK}
        	\resumeSubPointS
        		...
        		\item It convert models from all popular frameworks like tensorflow, pytorch, caffe, onnx etc., and creates optimized binaries for custom hardware.
      ...
      \resumeItemListStart
        ...
        \resumeItem{Digital Access Hub}
        	\resumeSubPointS
        		...
        		\item Developed NLP components such as NER, sequence translation ,QnA from the given knowledge base.
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Automation Designer(Python/C++)}
        	\resumeSubPointS
        		\item Developed an application to design and test a manufacturing sequence.
        		\item Implementation of use-cases and bug fixing to support the planned Nx releases.
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Application Developer(Python)}
			...
			\resumeSubPointS
        		\item Developed an application for client NCRA for Monitoring and Controlling of antennas. Detecting and debugging the issue reported in an aaplication. Solved the problem of false triggering of alarm's with the help of machine learning.
...
\resumeSubHeadingListStart
 ...
 \resumeCase
	...
	{Task is to implement Machine Translator. Attention mechanism was used to deal with longer sequences. After data cleaning and processing, output labels were padded with start and end tokens before feeding to n/w.}
